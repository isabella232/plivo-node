...
export class MessageInterface extends PlivoResourceInterface {
   ...
   * @param {list} [optionalParams.media_ids] For sending mms, specify the media ids in list of string
   ...
   * @param {Array} [optionalParams.media_ids] For sending mms, specify the media ids in list of string
   * @promise {object} return {@link PlivoGenericMessage} object if success
   * @fail {Error} return Error
   */
